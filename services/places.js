angular.module('roadTripIt')
	...
	function PlaceService() {
		...
		// 	{type: 'beachCities', allPlaces: ['Miami, Florida', 'San Diego, California', 'Malibu, California', 'Santa Cruz, California', 'New York City, New York', 'San Francisco, California', 'Traverse City, Michigan', 'Key West, Florida', 'Chincoteague, Virginia', 'Newport, Rhode Island', 'York Beach, Maine', 'Cape May, New Jersey']},
		// 	{type: 'plainCamping', allPlaces: ['Sage Creek Campground, South Dakota']},
		// 	{type: 'plainCities', allPlaces: ['Rapid City, South Dakota']}
